...
function contruirCard(titulo: string, descricao: string, url: string, imagem:string, categoria:string) {
...
const barraDePesquisa = document.querySelector("[data-pesquisa]") as HTMLInputElement;

barraDePesquisa.addEventListener("input", filtrarPesquisaCulinaria);

function filtrarPesquisaCulinaria() {
  const videos = document.querySelectorAll(".videos__item") as NodeListOf<HTMLElement>;
